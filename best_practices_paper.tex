...
\newcommand{\githubrepository}{\url{https://github.com/ocmadin/best-practices-paper}}  %this should be the main github repository for this article
...
\corr{michael.shirts@colorado.edu}{MRS}  % Correspondence emails.  FMS and FS are the appropriate authors initials.
\corr{email2@example.com}{FS}

\contrib[\authfn{1}]{These authors contributed equally to this work}
\contrib[\authfn{2}]{These authors also contributed equally to this work}

\presentadd[1]{Department of Chemical and Biological Engineering, University of Colorado, Boulder, CO}
\presentadd[2]{Computational Biology Program, Sloan Kettering Institute, Memorial Sloan Kettering Cancer Center, New York, NY}
...
%Plot saturation vs. number of molecules for water, glycerol, ethanol here.
...
\bibliography{best-practices-paper}
